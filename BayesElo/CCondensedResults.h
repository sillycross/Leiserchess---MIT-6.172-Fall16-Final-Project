...
public:  ////////////////////////////////////////////////////////////////////
  ...
  const CCondensedResult &GetCondensedResult(int Player, int i) const {return ppcr[Player][i];}
  CCondensedResult &GetCondensedResult(int Player, int i) {return ppcr[Player][i];}
